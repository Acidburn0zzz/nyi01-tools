...
sudo -u root -g wheel make -j${njobs} -DNO_ROOT kernel-toolchain KERNCONF=${kernel} ${target}
sudo -u root -g wheel make -j${njobs} -DNO_ROOT buildkernel KERNCONF=${kernel} ${target}
